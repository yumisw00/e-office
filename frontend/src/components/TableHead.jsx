                                            ...
                                            <>
                                                {m.is_async ? (
                                                    <AsyncSelect
                                                        ...
                                                        cacheOptions
                                                        loadOptions={(inputValue, callback) => props.loadOptions(inputValue, callback, m.name)}
                                                        value={props.filter && props.filter[m.name] ? (() => {
                                                            return dataarr.find(xx => xx.value == props.filter[m.name])
                                                        })() : null}
                                                    />
                                                ) : (
                                                    ...
                                                    <InputSelect
                                                        ...
                                                        isClearable
                                                        isMulti={false}
                                                        value={props.filter && props.filter[m.name] ? props.filter[m.name] : ''}
                                                        onChange={value => {
                                                            props.onChange(
                                                                m.name,
                                                                value,
                                ...
                                return (
                                    <td key={i} style={{ maxWidth: m.width }}>
                                        <input
                                            ...
                                            value={props.hasOwnProperty('filter') ? (props.filter && props.filter[m.name] ? props.filter[m.name] : '') : null}
                                        />
                                    </td>
                                )
                        })}
