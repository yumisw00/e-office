...
?>
<table style="border: 1px; width: 100%; border-collapse: collapse;" id="table_print">
    <thead>
        <tr>
            <th rowspan='2' style="color: white; border: 1px solid black; padding: 4px; text-align: left; background: #333399;">No</th>
            <th rowspan='2' style="color: white; border: 1px solid black; padding: 4px; text-align: left; background: #333399;">Ref. Sub Proses</th>
            ...
            <th colspan="11" style="color: black;background-color: #a0a8b0; border: 1px solid black; padding: 4px; text-align: left;">Pengujian Rancangan Pengendalian</th>
        </tr>
        <tr>
            ...
            <th style="color: black;background-color: #a0a8b0; border: 1px solid black; padding: 4px; text-align: left; ">Hasil Evaluasi CSA</th>
            <th style="color: black;background-color: #a0a8b0; border: 1px solid black; padding: 4px; text-align: left; ">Kesimpulan EUC</th>
            <th style="color: black;background-color: #a0a8b0; border: 1px solid black; padding: 4px; text-align: left; ">Kesimpulan MRC</th>
    ...
    <tbody>
        ...
        foreach ($data['list'] as $list) { ?>
            ...
            <tr>
                ...
                <td style="border: 1px solid black; padding: 4px; text-align: left;"> <?= $list->no_sub_proses ?></td>
                ...
                <td style="border: 1px solid black; padding: 4px; text-align: left;"> <?= $list->efektivitas_too ?></td>
                <td style="border: 1px solid black; padding: 4px; text-align: left;"> <?= $list->kesimpulan_euc ?></td>
                <td style="border: 1px solid black; padding: 4px; text-align: left;"> <?= $list->kesimpulan_mrc ?></td>
