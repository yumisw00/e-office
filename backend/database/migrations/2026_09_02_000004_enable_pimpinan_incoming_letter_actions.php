...
return new class extends Migration
{
    public function up(): void
    {
        ...
        $groupId = DB::table('sys_group')->where('nama', 'Pimpinan')->whereNull('deleted_at')->value('id_group');
        if (!$groupId) {
            return;
        }

        foreach (['disposisi' => ['index', 'add', 'edit'], 'surat_arsip' => ['index', 'add']] as $menuUrl => $actions) {
